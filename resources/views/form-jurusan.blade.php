  ...
  <body class="bg-gray-100 flex items-center justify-center min-h-screen">
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mt-10">
          <form>
              <!-- ID Prodi -->
              <div class="mb-4">
                  <label for="id_prodi" class="block text-sm font-medium text-gray-700">ID Jurusan</label>
              ...
              <!-- Nama Prodi -->
              <div class="mb-6">
                  <label for="nama_prodi" class="block text-sm font-medium text-gray-700">Nama Jurusan</label>
